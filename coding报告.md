...
![image-20250406030324638](D:\hello_zhu_desktop\研一\研一课程\可靠性\pre\code\assets\image-20250406030324638.png)

![image-20250406030424625](D:\hello_zhu_desktop\研一\研一课程\可靠性\pre\code\assets\image-20250406030424625.png)
...
| ------------- | --------------------- | ------------------ | ---------- |
| **B10寿命**   | [11.81 16.81]         | [10.43, 13.51]     | 11.81      |
| **尺度参数α** | [14.5, 19.2]          | [14.1, 19.8]       | 16.81      |
| **形状参数β** | [1.8, 2.5]            | [1.7, 2.6]         | 6.37       |

![image-20250406024822116](D:\hello_zhu_desktop\研一\研一课程\可靠性\pre\code\assets\image-20250406024822116.png)

**可靠性决策**：
   - 以Bootstrap的95%置信区间为准，B10寿命有95%概率在[10.43, 13.51]周期之间
   - 建议预防性维护时间设为**10.43周期**（保守估计）

**建议**：

   - 收集更多失效数据（至少再增加10个样本）可缩小置信区间约30%
   - 优先监控早期失效（β>1但置信区间包含β=1.7-2.6）
